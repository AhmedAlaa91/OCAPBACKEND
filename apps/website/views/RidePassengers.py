...
from apps.website.models import RidesBooked , Profile
...
class RequestsView(APIView):
    ...
    def send_mail_nofitication(self,rideid,Requestor_id,RideStatus,comment):
       ...
       # RidesBooked.objects.filter(RideRequested=rideid, Requestor=Requestor_id).delete()
        ...
        send_alerting_message ([{"email": passenger['email'], "name": passenger['first_name'] + ' ' + passenger['last_name']}] , content=passenger_details, subject=f'Ride {RideStatus}')