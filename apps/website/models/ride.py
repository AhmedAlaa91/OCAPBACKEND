...
from apps.website.managers import RideBookedManager
from apps.website.models.CarRegistration import Car


class Ride(models.Model):
    RIDE_TYPES = [("To Office", "To Office"), ("From Office", "From Office"), ("2-Way Ride", "2-Way Ride")]
